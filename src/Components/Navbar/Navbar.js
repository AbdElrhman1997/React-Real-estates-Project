...
const Navbar = () => {
    ...
    return (
        <header className='bg-slate-100 py-3 fixed top-0 w-full z-10 nav' data-aos='fade-bottom' data-aos-delay='500'>
            <div className='container flex mx-auto items-center grid grid-cols-12 gap-6 px-3'>
                <img src={logoImg} width='150' height='150' className=' col-span-3'/>
                <ul className='flex col-span-6 justify-around nav-list lg:flex md:flex hidden'>
                    <li ><a href='/'>Home</a></li>
                ...
                <div className='lg:hidden md:hidden block col-span-2'></div>
                <div className='bg-green-500 mx-auto p-3 rounded-md lg:hidden md:hidden block col-span-3 cursor-pointer' onClick={()=>{displayNav?setDisplayNav(false):setDisplayNav(true)}}><FaBars className='sm:text-2xl text-xl  text-white'/></div>
